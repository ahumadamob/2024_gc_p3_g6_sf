...
public class OrdenCompraController {
	...
	@ExceptionHandler(OrdenCompraNotFound.class)
	public ResponseEntity<APIResponse<String>> handleOrdenCompraNotFoundException(OrdenCompraNotFound ex) {
		APIResponse<String> response = new APIResponse<>(false, ex.getMessage());
		return new ResponseEntity<>(response, HttpStatus.NOT_FOUND);
	}
	@ExceptionHandler(Exception.class)
	public ResponseEntity<APIResponse<String>> handleGeneralException(Exception ex) {
		APIResponse<String> response = new APIResponse<>(false, "Error inesperado: " + ex.getMessage());
